                            ...
                            {data && data.map((item) => {
                              return (
                                  <TableRow hover style={{textDecoration: 'none'}} key={item.id}>
                                    ...
                                    <TableCell align="left"><button onClick={() => deleteCred(item._id)}><i style={{height : '25px',width: "25px",color:"red"}} class="fa fa-trash" aria-hidden="true"></i></button></TableCell>
